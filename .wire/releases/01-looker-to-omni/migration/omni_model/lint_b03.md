# Omni Model Lint: batch b03

Run 2026-09-06 by `/wire:omni-model-lint` on `migration/omni_model/b03/` (11 views, 3 topics, 8 relationships). Result: **FAIL**.
...
| L6 primary keys on joined views | FAIL | 3 |
...
|---|---|---|---|---|
| L6 | relationships.yaml | [0].join_to_view | `ad_campaigns_dim` | add primary_key: true to a dimension of the view |
| L6 | relationships.yaml | [1].join_from_view | `organic_posts_dim` | add primary_key: true to a dimension of the view |
| L6 | relationships.yaml | [5].join_to_view | `ips_enriched` | add primary_key: true to a dimension of the view |
